// Continuation prompt template + AUTOPILOT_COMPLETE detection.
...
export const COMPLETE_TOKEN = "AUTOPILOT_COMPLETE:";

export function buildContinuationPrompt(goal, fired, hardCap) {
    return (
        `[autopilot ${fired}/${hardCap}] Continue toward: "${goal}"\n` +
...
// explaining the autopilot mechanism, as it might in a debugging session).
